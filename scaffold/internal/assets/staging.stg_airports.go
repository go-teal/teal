...
insert into staging.stg_airports ({{ ModelFields }}) (select
    airport_code,
    airport_name,
    city,
    country,
...
var stagingStgAirportsModelDescriptor = &models.SQLModelDescriptor{
	...
	ModelProfile:  &configs.ModelProfile{
		Name: 				"stg_airports",
		Description: 		``,
		Stage: 				"staging",
		Connection: 		"default",
